-- Migration: Update search RPCs to support Collections scoping

-- 1. Update match_documents
...
BEGIN
  ...
  WHERE d.status = 'active'
    AND (
      ...
      d.assistant_id = match_assistant_id
      OR 
      -- Collection binding
      d.id IN (
        ...
        WHERE ac.assistant_id = match_assistant_id
      )
    )
